...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 600x450+357+78
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    vTcl:DefineAlias "$top.ent49" "registro" vTcl:WidgetProc "Toplevel1" 1
    entry $top.ent50 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -insertbackground black -width 244 
    vTcl:DefineAlias "$top.ent50" "tema" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab51 \
        -anchor w -background $vTcl(actual_gui_bg) -compound left \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
    ...
    entry $top.ent53 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -insertbackground black -width 244 
    vTcl:DefineAlias "$top.ent53" "descricao" vTcl:WidgetProc "Toplevel1" 1
    entry $top.ent54 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -insertbackground black -width 244 
    vTcl:DefineAlias "$top.ent54" "autores" vTcl:WidgetProc "Toplevel1" 1
    button $top.but56 \
    ...
    listbox $top.lis58 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -height 232 -width 534 
    ...
    place $top.lab52 \
        ...
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
    place $top.ent53 \
        -in $top -x 0 -relx 0.533 -y 0 -rely 0.089 -width 244 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.ent54 \
        -in $top -x 0 -relx 0.533 -y 0 -rely 0.244 -width 244 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but56 \
        -in $top -x 0 -relx 0.533 -y 0 -rely 0.333 -width 107 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but57 \
        -in $top -x 0 -relx 0.783 -y 0 -rely 0.333 -width 97 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lis58 \
        -in $top -x 0 -relx 0.05 -y 0 -rely 0.422 -width 0 -relwidth 0.89 \
